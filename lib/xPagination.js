...
var xPagination = new Class({
	...
	next: function() {
		...
		if ( this._initialised && this._page < ( this.options.pages - 1 ) ) {
			...
			this.fireEvent( 'pagechange', [this.options.element_right, ( this._page + 1 )] );
		}
	...
	previous: function() {
		...
		if ( this._initialised && this._page > 0 ) {
			...
			this.fireEvent( 'pagechange', [this.options.element_left, ( this._page - 1 )] );
